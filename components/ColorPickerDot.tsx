...
// Omit to hide them:
//
// interface ColorPickerDotProps extends Omit<DefaultColorPickerDotProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function ColorPickerDot_(
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicColorPickerDot are:
  // 1. Variants you want to activate,
  // 2. Contents for slots you want to fill,
  // 3. Overrides for any named node in the component to attach behavior and data,
  // 4. Props to set on the root node.
  //
  // By default, we are just piping all ColorPickerDotProps here, but feel free
  // to do whatever works for you.

  return <PlasmicColorPickerDot root={{ ref }} {...props} />;
}

const ColorPickerDot = React.forwardRef(ColorPickerDot_);
