...
// Omit to hide them:
//
// interface ColorPickerProps extends Omit<DefaultColorPickerProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function ColorPicker_(props: ColorPickerProps, ref: HTMLElementRefOf<"div">) {
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicColorPicker are:
  // 1. Variants you want to activate,
  // 2. Contents for slots you want to fill,
  // 3. Overrides for any named node in the component to attach behavior and data,
  // 4. Props to set on the root node.
  //
  // By default, we are just piping all ColorPickerProps here, but feel free
  // to do whatever works for you.

  return <PlasmicColorPicker root={{ ref }} {...props} />;
}

const ColorPicker = React.forwardRef(ColorPicker_);
